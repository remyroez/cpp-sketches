...
void test_system() {
	...
	system.emplace(100, 123, 456, "foo");
	system.emplace(200, 789, 741, "bar");
	system.emplace(300, 852, 963, "baz");
...
void test_component() {
	...
	system.emplace(100, 123.456f, 456.0f);
	auto component = system.get_component(100);
...
void test_remove_component() {
	...
	system.emplace(0, 123);
	system.emplace(1, 456);
	system.emplace(2, 789);
...
void test_system_size() {
	...
	std::cout << "ecs::system<>: " << sizeof(ecs::system<>) << std::endl;
	std::cout << "ecs::system<int>: " << sizeof(ecs::system<int>) << std::endl;
	std::cout << "ecs::system<int, int>: " << sizeof(ecs::system<int, int>) << std::endl;
	std::cout << "ecs::system<int, int, int, int>: " << sizeof(ecs::system<int, int, int, int>) << std::endl;
	std::cout << "ecs::system<int, int, int, int, int, int, int, int>: " << sizeof(ecs::system<int, int, int, int, int, int, int, int>) << std::endl;
}
...
void test_world() {
	...
	auto print_name = [](const name_system::component &component) {
		...
		std::cout << "\t\tname: " << std::get<0>(component) << std::endl;
		std::cout << "\t}" << std::endl;
	};

	auto print_position = [](const position_system::component &component) {
		std::cout << "\tposition {" << std::endl;
		std::cout << "\t\tx: " << std::get<0>(component) << std::endl;
		std::cout << "\t\ty: " << std::get<1>(component) << std::endl;
		std::cout << "\t}" << std::endl;
	};

	auto print_health = [](const health_system::component &component) {
		std::cout << "\thealth {" << std::endl;
		std::cout << "\t\tpoint: " << std::get<0>(component) << std::endl;
		std::cout << "\t}" << std::endl;
	};
	...
	my_world world;
	{
		...
		world.emplace<k_name_system>(entity, std::string("alpha"));
		world.emplace<k_position_system>(entity, 123, 456);
		world.emplace<k_health_system>(entity, 0.54f);
	}
	ecs::entity_id id = 0;
	{
		auto entity = world.make_entity();
		world.emplace<k_name_system>(entity, std::string("bravo"));
		world.emplace<k_position_system>(entity, 789, 999);
		world.emplace<k_health_system>(entity, 0.01f);
		id = entity;
	}
	{
		auto entity = world.make_entity();
		world.emplace<k_name_system>(entity, std::string("chalie"));
		world.emplace<k_position_system>(entity, 100, 200);
		world.emplace<k_health_system>(entity, 1.25f);
	}
	world.remove_entity(id);
	{
		auto entity = world.make_entity();
		world.emplace<k_name_system>(entity, std::string("delta"));
		world.emplace<k_position_system>(entity, 12345, 67890);
		world.emplace<k_health_system>(entity, 123.456f);
	}
